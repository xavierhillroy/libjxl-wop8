...
def generate_run_name(dataset_name, train_ratio, max_train_images, 
    ...
    """
    Generate a standardized run name including all parameters.
    
    Returns:
        str: Formatted name including all parameters
    """
    ...
    return (f"{dataset_name}_tr{train_ratio_str}_max{max_train_images}_"
            ...
            f"x{crossover_rate_str}_e{elitism_count}_t{tournament_size}")
