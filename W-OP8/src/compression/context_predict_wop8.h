...
const uint32_t w1 = 0x4;
const uint32_t w2 = 0x3;
const uint32_t w3 = 0x1;
const uint32_t w4 = 0xf;  // Adaptive MED weight
const uint32_t w5 = 0x0;  // Enhanced Adaptive Median weight
const uint32_t w6 = 0xe;  // Paeth weight
const uint32_t w7 = 0x4;  // GAP weight
